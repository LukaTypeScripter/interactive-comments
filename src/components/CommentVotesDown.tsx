...
function CommentVotesDownComponent({score}:props) {
  ...
  return (
    <><PlusAndMinusBtn onClick={handleUpvote}>
      ...
      </PlusAndMinusBtn><VotesCouter>
              {voteCount === 0 ? "0" : voteCount}
          </VotesCouter><PlusAndMinusBtn onClick={handleDownvote}>
...
export default CommentVotesDownComponent